...
export default function AboutPage() {
  ...
  const team = [
    { name: t('Rooh Ul Hasnain', 'روح الحسنين'), role: t('Founder & CEO', 'المؤسس والرئيس التنفيذي'), initials: t('RH', 'ره'), bio: t('Visionary leader driving Cubico\'s mission to transform education through technology. 12+ years in education and tech.', 'قائد صاحب رؤية يقود مهمة كيوبيكو لتحويل التعليم من خلال التكنولوجيا. أكثر من 12 عامًا في التعليم والتقنية.'), gradient: 'from-[#E8634A] to-[#E8634A]' },
    { name: t('Abdul Raffay Vohra', 'عبد الرفاي فوهرا'), role: t('Co-Founder & CSO', 'المؤسس المشارك ومسؤول الاستراتيجية'), initials: t('AV', 'عف'), bio: t('Strategic mind behind Cubico\'s growth. Expert in scaling EdTech solutions across emerging markets.', 'العقل الاستراتيجي وراء نمو كيوبيكو. خبير في توسيع حلول تكنولوجيا التعليم عبر الأسواق الناشئة.'), gradient: 'from-[#B85E15] to-[#E8634A]' },
    { name: t('Hassan Khan', 'حسان خان'), role: t('Head of Engineering', 'رئيس قسم الهندسة'), initials: t('HK', 'حخ'), bio: t('Led product at two EdTech startups before joining Cubico.', 'قاد المنتجات في شركتين ناشئتين في تكنولوجيا التعليم قبل الانضمام إلى كيوبيكو.'), gradient: 'from-[#C0651A] to-[#E8634A]' },
    { name: t('Ayesha Malik', 'عائشة مالك'), role: t('Creative Director', 'المديرة الإبداعية'), initials: t('AM', 'عم'), bio: t('Animation specialist. Designed curricula used by 200+ schools.', 'متخصصة في الرسوم المتحركة. صممت مناهج تستخدمها أكثر من 200 مدرسة.'), gradient: 'from-[#D14F38] to-[#E8634A]' },
    ...
    { name: t('Nadia Bukhari', 'نادية بخاري'), role: t('VP Operations', 'نائبة رئيس العمليات'), initials: t('NB', 'نب'), bio: t('Manages onboarding for 100+ schools per quarter across 3 countries.', 'تدير عملية ضم أكثر من 100 مدرسة كل ربع سنة عبر 3 دول.'), gradient: 'from-[#CD853F] to-[#E8634A]' },
  ];
  ...
  return (
    <>
      <style>{`
        ...
        .shimmer-text {
          background:linear-gradient(90deg,#E8634A 0%,#E8634A 30%,#F4A94D 50%,#E8634A 70%,#E8634A 100%);
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeUp} custom={0} className="mb-4">
              <span className="inline-flex items-center gap-2 text-[11px] font-bold tracking-[0.2em] uppercase px-4 py-1.5 rounded-full border border-orange-200/60 bg-orange-50/60 text-[#E8634A]">
              ...
              >
                ...
                <div className={`relative rounded-2xl overflow-hidden shadow-lg ${i % 2 !== 0 ? 'md:order-2' : ''}`} style={{ aspectRatio: '16/10' }}>
                  ...
                  <div className="absolute bottom-4 left-4">
                    <span className="inline-block text-xs font-black tracking-[0.2em] uppercase text-white bg-[#E8634A] px-3 py-1 rounded-full">{item.year}</span>
                  </div>
                </div>

                {/* Content */}
                <div className={`${i % 2 !== 0 ? 'md:order-1 md:text-right' : ''}`}>
                  <span className="inline-block text-[11px] font-black tracking-[0.2em] uppercase text-[#E8634A] mb-2">{item.year}</span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-10 mb-16 items-center">
            ...
            <div className="space-y-6">
              ...
              >
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#E8634A] to-[#E8634A]" />
                <div className="w-12 h-12 rounded-xl bg-orange-50 flex items-center justify-center mb-5">
                  <Lightbulb className="w-6 h-6 text-[#E8634A]" />
                </div>
              ...
              <motion.div
                ...
                className="relative rounded-2xl bg-white border border-gray-100 p-8 overflow-hidden shadow-sm"
              >
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#B85E15] to-[#E8634A]" />
          ...
          >
            {values.map((v, i) => (
              ...
              >
                <div className="w-11 h-11 rounded-xl bg-orange-50 flex items-center justify-center mb-4 group-hover:bg-[#E8634A] group-hover:text-white transition-colors">
                  <v.icon className="w-5 h-5 text-[#E8634A] group-hover:text-white transition-colors" />
                </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          >
            {[
              { icon: Monitor, name: 'Cubico Manage™', desc: t('All-in-one school ERP — admissions, attendance, finance, HR, and reporting in a single dashboard.', 'نظام ERP مدرسي متكامل — القبول، الحضور، المالية، الموارد البشرية، والتقارير في لوحة تحكم واحدة.'), accent: '#E8634A', img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80' },
              { icon: BookOpen, name: 'Moodle LMS Setup', desc: t('Your branded Moodle platform — configured, hosted, and supported. Live in 2 weeks.', 'منصة Moodle بعلامتك التجارية — مُعدّة ومُستضافة ومدعومة. جاهزة خلال أسبوعين.'), accent: '#E8634A', img: 'https://images.unsplash.com/photo-1501504905252-473c47e087f8?auto=format&fit=crop&w=600&q=80' },
              ...
              { icon: TrendingUp, name: 'Cubico Marketing™', desc: t('School websites, enrollment funnels, social media management, and SEO — fill every seat.', 'مواقع المدارس، قمع التسجيل، إدارة وسائل التواصل الاجتماعي، وتحسين محركات البحث — املأ كل مقعد.'), accent: '#D14F38', img: 'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?auto=format&fit=crop&w=600&q=80' },
            ].map((product, i) => (
              <motion.div
                key={product.name}
                variants={fadeUp}
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-72 h-72 bg-[#E8634A]/12 rounded-full filter blur-[110px]" />
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#D14F38]/10 rounded-full filter blur-[110px]" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                ...
                <p className="text-[#E8634A] text-xs font-bold tracking-wider uppercase mb-0.5">{s.label}</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { country: t('Pakistan', 'باكستان'), cities: t('Lahore, Karachi, Islamabad', 'لاهور، كراتشي، إسلام آباد'), schools: '480+', languages: t('English & Urdu', 'الإنجليزية والأردية'), accent: '#E8634A', img: 'https://images.unsplash.com/photo-1567057419565-4349c49d8a04?auto=format&fit=crop&w=600&q=80' },
              ...
              { country: t('Canada', 'كندا'), cities: t('Toronto, Ottawa, Calgary', 'تورنتو، أوتاوا، كالجاري'), schools: '60+', languages: t('English & French', 'الإنجليزية والفرنسية'), accent: '#D14F38', img: 'https://images.unsplash.com/photo-1517935706615-2717063c2225?auto=format&fit=crop&w=600&q=80' },
            ].map((loc, i) => (
              <motion.div
                key={loc.country}
                initial={{ opacity: 0, y: 24 }}
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#E8634A] font-semibold">{member.role}</p>
                  </div>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.div variants={fadeUp} custom={3}>
                <a href="/contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-[#E8634A] to-[#E8634A] text-white text-sm font-semibold px-6 py-3 rounded-full transition-all hover:shadow-lg hover:shadow-orange-500/25">
            ...
            >
              ...
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.08 }}
                  className="flex gap-3.5 p-4 rounded-xl bg-white border border-gray-100 shadow-sm hover:shadow-md hover:border-[#E8634A]/20 transition-all"
                >
                  <CheckCircle2 className="w-5 h-5 text-[#E8634A] flex-shrink-0 mt-0.5" />
                  <div>
